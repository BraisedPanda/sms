...
import com.xqy.sms.ai.infrastructure.service.log.AiToolExecuteLogService;
import com.xqy.sms.ai.domain.model.AiTask;
import com.xqy.sms.ai.domain.model.AiTaskResult;
import com.xqy.sms.ai.domain.model.AiToolDefinitionProvider;
...
public class AiToolRegistry {
    ...
    public AiTaskResult execute(AiTask task) {
        ...
        com.xqy.sms.common.entity.AiToolExecuteLog executionLog = logger == null ? null : logger.start(task, null);
        try {
